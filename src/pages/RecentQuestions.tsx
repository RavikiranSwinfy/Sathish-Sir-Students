...
const RecentQuestions: React.FC = () => {
  ...
  const handleSubmitAnswer = async (e: React.FormEvent) => {
    e.preventDefault();
    if (selectedQuestion && answerText.trim() && answeredBy.trim()) {
      try {
        await addAnswer({
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <img 
            src="https://images.pexels.com/photos/356079/pexels-photo-356079.jpeg?auto=compress&cs=tinysrgb&w=64&h=64&dpr=1" 
            alt="Loading" 
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Recent Questions</h1>
        <p className="text-gray-600">Questions submitted by users, grouped by topic</p>
      </div>

      {Object.keys(groupedQuestions).length === 0 ? (
        <div className="text-center py-12">
          <img 
            src="https://images.pexels.com/photos/356079/pexels-photo-356079.jpeg?auto=compress&cs=tinysrgb&w=48&h=48&dpr=1" 
            alt="No questions" 
          ...
          {Object.entries(groupedQuestions).map(([topic, topicQuestions]) => (
            <div key={topic} className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                <img 
                  src="https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&cs=tinysrgb&w=20&h=20&dpr=1" 
                  alt="Topic" 
                    ...
                    <div className="flex items-center justify-between text-sm text-gray-500 mb-3">
                      <div className="flex items-center space-x-4">
                        <span className="flex items-center">
                          <img 
                            src="https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&cs=tinysrgb&w=12&h=12&dpr=1" 
                            alt="User" 
                        ...
                        <span className="flex items-center">
                          <img 
                            src="https://images.pexels.com/photos/3184292/pexels-photo-3184292.jpeg?auto=compress&cs=tinysrgb&w=12&h=12&dpr=1" 
                            alt="Date" 
                            className="h-3 w-3 mr-1 rounded"
                          />
                      ...
                      <span className="text-xs">
                        {getAnswerCount(question.id)} answers
                      </span>
                    </div>
